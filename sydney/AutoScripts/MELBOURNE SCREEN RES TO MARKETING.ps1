...
$LOG_ROOT = "\\galaxy\IT\AutoScripts\Logs\PowerShell\Melbourne_SMD_Marketing\"
$SMD_ROOT = "\\galaxy\imagedata\01_MELBOURNE_CLIENTS\INPRODUCTION\*_RETOUCH\*_Done*\Screen Res\*.jpg";
